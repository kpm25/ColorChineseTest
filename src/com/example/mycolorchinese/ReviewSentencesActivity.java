...
public class ReviewSentencesActivity extends Activity{
...
{  
			...
			setContentView(R.layout.activity_review_sentences);
		 
	 btnClassroom = (Button)findViewById(R.id.buttonReviewSentences);
		...
		myDb = new DatabaseHelper(this);
		  ...
		  Cursor res = myDb.getSentenceDataByListtitleDistinct();
		    
          if(res.getCount() == 0) {
              // show message
              showMessage("There are no currently no Sentence Lists in database!!","Go to Data Management, under Sentences section,  to either load default lists, create new, or upload lists from file.");
              return;
          }
			...
			new View.OnClickListener()
                  {
		            ...
		            { 
		            	...
		            	Intent intent = new Intent(getApplicationContext(), ReviewSentenceClassroomActivity.class);
...
private void checkIfAllChecked()
{
	...
	CheckBox checkboxAll = (CheckBox) findViewById(R.id.checkBoxAllSentences);
...
{  
   ...
   if (modulus ==1)
	...
	TableLayout table = (TableLayout) findViewById(R.id.tableForSentenceLists); 
