...
public class CharacterDatabaseActivity  extends Activity  {
	...
	TextView idLabel,listtitleLabel,characterLabel, pinyinLabel,pinyinInstructionLabel;
    EditText editListtitle, editCharacter, editPinyin ,editTextId , editQuery;
    Button btnAddData;
    Button btnUpdate;
	...
	Button button2;
	Button button3;
	Button buttonPinyinCovert, buttonQuery;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttonPinyinCovert.setWidth(200);
		buttonPinyinCovert.setBackgroundColor(Color.rgb(153,153,153));
...
RelativeLayout.LayoutParams textDetails = new RelativeLayout.LayoutParams(
		...
		this.setTitle("Chinese Character Table Manager...");
...
/*
                   ...
                   */
                    	...
                    	if(query.contains("vocabtable"))
		       	        	...
		       	        	query = query.replace("vocabtable", "");
		       	        	 Toast.makeText(CharacterDatabaseActivity.this, "Can't query to vocabtable from here!", Toast.LENGTH_LONG).show();
		       	        	 return;
		               		 }
		                      else if(query.contains("sentencetable"))
		               		 {
		       	        	query = query.replace("sentencetable", "");
		       	        	 Toast.makeText(CharacterDatabaseActivity.this, "Can't query to sentencetable from here!", Toast.LENGTH_LONG).show();
		       	        	  return;
		               		 }
		                      else
		                      {
        ...
        (
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                    	...
                    	{
                    		Toast.makeText(CharacterDatabaseActivity.this,"Pinyin is Too Long, is not converted, or is empty!!!\n\nMax length of pinyin is 6 characters.",Toast.LENGTH_LONG).show();
                            return;
                    	}
	...
	public void loadCharactersFromFile()
	{
        ...
        (
                new View.OnClickListener()
                {
                    ...
                    { 
                    	 ...
                    	 Toast.makeText(CharacterDatabaseActivity.this,"chineseCharacterArraylist: "+chineseCharacterArraylist.get(0).getListtitle(),Toast.LENGTH_LONG).show();
                   	...
                   	if(isInserted == true)
                        Toast.makeText(CharacterDatabaseActivity.this,"Data Inserted",Toast.LENGTH_LONG).show();
                    else
                        Toast.makeText(CharacterDatabaseActivity.this,"Data not Inserted",Toast.LENGTH_LONG).show(); 
                    }
                }
        );
        						...
        						.setPositiveButton("Yes.",
        								new DialogInterface.OnClickListener() {
        									...
        									//	VocabDatabaseActivity.this.finish();
        				                    	 ...
        				                    	 Integer deletedRows = myDb.deleteAllCharacterData();
        				                         if(deletedRows > 0)
        				                             Toast.makeText(CharacterDatabaseActivity.this,"Data Deleted..  "+deletedRows+" rows were deleted!!",Toast.LENGTH_LONG).show();
        				                         else
        				                             Toast.makeText(CharacterDatabaseActivity.this,"Data not Deleted",Toast.LENGTH_LONG).show();
        ...
        (
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                    	...
                    	startActivity(new Intent(getApplicationContext(), FileLoadCharacterActivity.class));
    ...
    public void DeleteData() {
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Integer deletedRows = myDb.deleteCharacterData(editTextId.getText().toString());
                        if(deletedRows > 0)
                            Toast.makeText(CharacterDatabaseActivity.this,"Data Deleted..at id: "+editTextId.getText().toString(),Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(CharacterDatabaseActivity.this,"Data not Deleted",Toast.LENGTH_LONG).show();
                    }
                }
        ...
        btnUpdate.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                    	...
                    	{
                    		 showMessage("No ID number Entered to Update!!","");
                    		return;
                    	}
                    	
                    	if(( editCharacter.getText().toString().length()>1)||editCharacter.getText().toString().length()==0 )
                    	{
                    		 Toast.makeText(CharacterDatabaseActivity.this,"Can only enter a single Character, or is empty!",Toast.LENGTH_LONG).show();
                            return;
                    	}
                    	...
                    	{
                    		Toast.makeText(CharacterDatabaseActivity.this,"Listtitle is Too Long, or is empty!!!\n\nMax length of listtitle is 15 characters.",Toast.LENGTH_LONG).show();
                            return;
                    	}
                    	if((editPinyin.getText().length()>6) ||editPinyin.getText().toString().length()==0  )
                    	{
                    		Toast.makeText(CharacterDatabaseActivity.this,"Pinyin is Too Long, is not converted, or is empty!!!\n\nMax length of pinyin is 6 characters.",Toast.LENGTH_LONG).show();
                            return;
                    	}
                    	
                    	Cursor res = myDb.getCharacterData(Integer.parseInt(editTextId.getText().toString()));
                        if(res.getCount() == 0) {
                            // show message
                        	Toast.makeText(CharacterDatabaseActivity.this,"No Data exists at this ID!",Toast.LENGTH_LONG).show();
                            return;
                        }
                        ...
                        if(isUpdate == true)
                            Toast.makeText(CharacterDatabaseActivity.this,"Data Update",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(CharacterDatabaseActivity.this,"Data not Updated",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
        ...
        btnAddData.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                    	...
                    	{
	                       boolean isInserted = myDb.insertCharacterData(editListtitle.getText().toString(),
	                    		   editCharacter.getText().toString().charAt(0),
